...
The funny thing is, this pattern (called the "decorator" pattern) is actually more relevant today than it was in 2008, given that page sizes have ballooned. People just ignore the problem because they assume everybody has a fast connection these days.
